                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="vananchalprefabconcretes@gmail.com?Subject=Flower%20greetings%20to%20you"><i class="icon-mail"></i> vananchalprefabconcretes@gmail.com</a></li>
                                <li><a href="locations.html"><i class="icon-placeholder"></i> Jharkhand</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="#">Our Products</a>
                                            <ul>
                                                <li><a href="#">Shop</a></li>
