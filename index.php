...
<head>
    ...
    <title>Vananchal Prefab Concretes</title>
...
<div class="body-wrapper">    
    ...
    <div class="ltn__slider-area ltn__slider-3  section-bg-2---">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60---" data-bg="img/banner.jpg">
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <h1 class="slide-title animated text-light">Highest Standards <br> Of Construction</h1>
                                        <div class="slide-brief animated">
                                            <p class="text-light">All types of work – from designing and laying the Foundation
